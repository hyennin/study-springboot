package study.springboot.springbootdeveloper.controller;
...
import study.springboot.springbootdeveloper.dto.ArticleResponse;
...
class BlogApiControllerTest {
    ...
    @DisplayName("AddArticle: 블로글 수가에 성공한다")
    @Test
    ...
    @Test
    public void fintAllArticles() throws Exception {
        final String url = "/api/articles";
        final String title = "title";
        final String content = "content";
